package com.wxy.circle.server.websocket;

import com.wxy.circle.server.config.WebSocketServerConfig;
...
@Slf4j
@ServerEndpoint(value = "/yunju/socket", configurator = WebSocketServerConfig.class)
@Component
public class YunJuSocket {
     ...
     * 存放所有在线的客户端
     */
    private static final Map<String, YunJuSocket> clients = new ConcurrentHashMap<>();
    ...
    public void sendMessage(String message) {
        for (Map.Entry<String, YunJuSocket> sessionEntry : clients.entrySet()) {
            String erp = sessionEntry.getKey();
            YunJuSocket socket = sessionEntry.getValue();
    ...
    public YunJuSocket getYunJuSocket(String userName) {
