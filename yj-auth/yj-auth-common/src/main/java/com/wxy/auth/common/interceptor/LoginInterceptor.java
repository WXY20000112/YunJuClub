package com.wxy.auth.common.interceptor;
...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(
        ...
        // 获取用户信息
        String loginId = request.getHeader(AuthConstant.LOGIN_ID);
        // 将用户信息加入线程中
        LoginContextHolder.setContext(AuthConstant.LOGIN_ID, loginId);
        return true;
    }
